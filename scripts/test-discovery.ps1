...
#
# Broadcasts the Alpaca discovery message on UDP port 32227 and prints any
# responses. Use this to verify that alpaca-switch is reachable from the
# machine running NINA before troubleshooting NINA itself.
#
# Run from PowerShell:
#   pwsh -File scripts/test-discovery.ps1
